...
int main()
{
    ...
    while (true)
    {
        ...
        case 1:
            ...
            temp.first.erase(remove(temp.first.begin(), temp.first.end(), '\n'), temp.first.end());
            ...
            {
                cout << "Nome não pode conter espaços. Tente novamente." << endl;
                break;
            }
            temp.second = index;
            index++;
        ...
        case 2:
            ...
            {
                cout << "Aluno: " << aluno.first << ", Matrícula: " << aluno.second << endl;
            }
            break;
